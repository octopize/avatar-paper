...
# Perform FAMD in the original data space
...
# ggsave(file="../figures/WBCD_pca2D_Ksmall_high.svg", plot = plot, width = 10, height = 7, dpi = 320)
...
# ggsave(file = "../figures/WBCD_localCloaking_violinplot.svg", plot = plot, width = 10, height = 7)

...
class DimensionReduction:
    ...
    def fit(self, X):
        ...
        if self.col_w is None:
            ...
            raise ValueError("col_w", "The weight parameter should be of size  " + str(X.shape[1]) + '.')
    ...
    def transform(self, X):
        ...
        if not self.__is_fitted:
            raise NotFittedError("This {} instance is not fitted yet. Call 'fit' or 'fit_transform' before using this estimator.".format(type(self).__name__))

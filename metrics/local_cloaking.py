...
def local_cloaking(records_set_coordinates, avatars_set_coordinates, record_to_avatar_distances, subset_indices=None):
    ...
    hit_counts = radius_knn(records_set_coordinates, avatars_set_coordinates, record_to_avatar_distances)

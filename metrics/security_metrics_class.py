...
class Security_metrics:
    ...
    def fit(self, records_set, avatars_set, nf):
        ...
        are_first_hit = avatars_are_first_hit (self._coord_original, self._coord_avatar, distance_metric='minkowski')
        # Hidden rate
        self.hidden_rate = hidden_rate(are_first_hit)

        self._distances = record_to_avatar_distance(self._coord_original, self._coord_avatar)
        
        # Local cloaking
        self.local_cloaking = local_cloaking(self._coord_original, self._coord_avatar, self._distances, subset_indices=None)
